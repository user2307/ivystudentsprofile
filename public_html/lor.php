...
if($path_lor[$lor])
{echo '<h2>Recommendation Letter</h2>';
$get_file=file_get_contents('http://' . $_SERVER['HTTP_HOST'] . $path_lor[$lor]);
echo '<p>'.nl2br(htmlspecialchars($get_file)).'</p>';
}?>
...
echo '<li><a href="lor.php?id='.$uid.'&lor='.$i.'">Recommendation Letter'.$m++.'</a></li>';
}
}
echo '                                                        </ul>
                                                </section>
