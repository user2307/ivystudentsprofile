...
<!-- Basic Page Needs
	================================================== -->
	<meta charset="utf-8">
	<title>Scholarship Essay: Ivystudentsprofile</title>
...
if($sch_nm[$essay] && $sch_pth[$essay])
echo '<h2>'.$sch_nm[$essay].' </h2>';
else
echo '<h2>Scholarship Essay</h2>';
if($sch_amt[$essay])
echo '<h4>Received '.$sch_amt[$essay].'</h4>';
$get_file=file_get_contents('http://' . $_SERVER['HTTP_HOST'] . $sch_pth[$essay]);
...
<?php
$j=0;
for($i=0;$i<count($sch_pth);$i++){
//{
if($i!=$essay && $sch_pth[$i])
{
$j++;
...
<section class="widget">
                                                        <h3>Related Scholarship Essays</h3>
...
{
if($sch_pth[$i])
echo '<li><a href="user-content.php?id='.$uid.'&essay='.$i.'">'.$sch_pth[$i].'</a></li>';
else
echo '<li><a href="user-content.php?id='.$uid.'&essay='.$i.'">Scholarship Essay</a></li>';
}
}
echo '                                                        </ul>
                                                </section>
